...
(function () {
  ...
  const HEADLINERS = [
    ...
    person({
      ...
      category: 'Hraniční případ',
      categoryReason: 'Profiluje se jako nezávislý expert na finanční gramotnost a spotřebitele, fakticky je to loajální obhájce Babišova střetu zájmů a postava na výplatní pásce PR agentury Home Creditu z doby čínské kampaně. Jedna doložená osa, zbytek spíš loajalita než systém — proto Hraniční, blíže nule.',
    ...
    person({
      ...
      category: 'Není zmrd',
      categoryReason: 'Cesta na Tchaj-wan 2020 byla doložené zásadové gesto navzdory odporu prezidenta i části vlády a navzdory čínskému nátlaku — opak oportunismu. Žádná doložená lež, finanční střet, toxicita ani otáčení kabátu. Politik s pevnou linií, ne zmrd.',
    ...
    person({
      ...
      categoryReason: 'Politolog, který vládne jako přednášející — věcně, opatrně, bez vlastního ekosystému. Nemá rodinné finanční toky, dotační ocas ani toxickou rétoriku; Demagog ho po stovkách výroků drží v poměru, jaký systémový zmrd nikdy nemá. Jediná hrana je opožděné otočení v postojích podle volebního kalendáře — to z něj dělá slabého lídra, ne zmrda.',
      dictum: 'Slabý lídr není zmrd: žádná exhibice, žádný profit přes rodinu, jen vláda, která sliby plní napůl a reformu objeví těsně před volbami.',
      lit: ['konzistence'],
      overrides: {
    ...
    person({
      ...
      role: 'ministr vnitra, předseda hnutí STAN',
    ...
    person({
      ...
      category: 'Jedna skvrna',
      categoryReason: 'Technokrat rozpočtů, kterého Demagog drží téměř čistého (8 nepravd ze 123 výroků) a u něhož chybí dotační ocas i toxická rétorika. Jediná doložená skvrna je bitcoinová kauza: jeho ministerstvo bylo o miliardovém daru informováno 30. ledna 2025 a měsíce nekonalo. Vyhnutí se odpovědnosti přes podřízené osu zbabelosti rozsvěcí — na systémové zmrdství to ale nestačí.',
      dictum: 'Jedna skvrna na technokratovi: dopis o miliardě v bitcoinech přišel v lednu, schůzka se „někde zaúřadovala“ — a vinu nese proces, ne ministr.',
      lit: ['zbabelost'],
      dfens: [
      ...
      overrides: {
        ...
        konzistence: { text: 'Bez doloženého obratu v klíčových postojích či stranických přesunů.' },
      },
    }),
    person({
