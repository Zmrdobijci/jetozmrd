...
(function () {
  ...
  const DIMENSIONS = [
    ...
    { key: 'konzistence', q: 'Je nekonzistentní?',    label: 'Konzistence',
  ...
  const HEADLINERS = [
    ...
    person({
      id: 'vrabel', name: 'Ladislav Vrábel', party: 'Česká republika na 1. místě!',
      role: 'organizátor protivládních demonstrací „Česko proti bídě“, figura dezinformační scény',
      scope: 'celostátní',
      category: 'Oportunistický zmrd',
      categoryReason: 'Není to přesvědčený ideolog ani systémový hráč s mocí — je to figura, která ucítila příležitost. Cestu si prošlapal od Strany zelených přes protiislámské a protiuprchlické postoje až po proruskou demonstrační scénu, vždy tam, kde zrovna foukalo. Peníze od důvěřivých příznivců skončily na soukromém účtu manželky. Ne „Systémový“ (žádný úřad, žádná páka), ne „Exhibicionistický“ (nejde o show samu o sobě, ale o příjem a vliv).',
      dictum: 'Vlastenec, kterému půl milionu od lidu zabloudilo na účet manželky a dotace na covid do kapsy.',
      highlight: 'Po zářijové demonstraci 2022 na Václavském náměstí Vrábel poděkoval příznivcům za zhruba půl milionu korun — peníze ale šly na soukromý účet jeho manželky u České spořitelny, ne na sbírkový účet, jak vyžaduje zákon (sbírku smí pořádat jen právnická osoba). Krajský soud v Českých Budějovicích ho předvolal, aby vysvětlil, jak s dary nakládal; doklady o konkrétních výdajích nedoložil. Souběžně byl v insolvenci s dluhy kolem 3 milionů korun, soud mu v lednu 2023 zrušil oddlužení pro nepoctivý záměr a prohlásil konkurz.',
      lit: ['penize', 'lze', 'konzistence'],
      dfens: [
        { n: 1, why: 'Dvouhodinová videa a vystoupení na demonstracích — produkce poplašných tvrzení o „jaderném útoku“ a blížící se bídě bez faktického základu.' },
        { n: 4, why: 'Trajektorie od Strany zelených (2010) přes protiislámské/protiuprchlické postoje až po proruskou demonstrační scénu — postoj se mění podle aktuální příležitosti.' },
        { n: 6, why: 'Statisíce od příznivců směrované na soukromý účet manželky mimo sbírkový režim; insolvenční správce dovodil „odklánění“ prostředků z majetkové podstaty.' },
        { n: 9, why: 'Demonstrace a katastrofické narativy jako nástroj na získání vlivu a financí — analytici ho popisují jako čistého oportunistu, ne přesvědčeného propagandistu.' },
      ],
      overrides: {
        penize: { text: 'Po demonstraci na Václavském náměstí v září 2022 Vrábel poděkoval příznivcům za zhruba 500 000 Kč; prostředky směřovaly na soukromý účet jeho manželky u České spořitelny, nikoli na sbírkový účet podle zákona (veřejnou sbírku smí pořádat jen právnická osoba). Krajský soud v Českých Budějovicích ho předvolal, aby vysvětlil nakládání s dary; konkrétní výdaje nedoložil. Souběžně byl v insolvenci s dluhy kolem 3 mil. Kč — soud mu v lednu 2023 zrušil oddlužení pro nepoctivý záměr a prohlásil konkurz, mj. kvůli „odklánění“ prostředků na účet manželky. V říjnu 2023 jihočeská policie zahájila trestní stíhání pro dotační podvod podle § 212 tr. zákoníku (covidové dotace, škoda bezmála 1,7 mil. Kč), s hrozbou až 8 let.',
          src: [S('Aktuálně.cz', 'Soud chtěl, aby Vrábel vysvětlil, co udělal se statisícovými dary; peníze šly na účet manželky', 'https://zpravy.aktualne.cz/domaci/vrabel-soud-penize/r~cee321b22eb111eda873ac1f6b220ee8/'), S('Seznam Zprávy', 'Soud poslal Vrabela do konkurzu, sám se usvědčil z nepoctivosti', 'https://www.seznamzpravy.cz/clanek/domaci-kauzy-soud-poslal-vrabela-do-konkurzu-sam-se-usvedcil-z-nepoctivosti-223199'), S('Seznam Zprávy', 'Policie obvinila Vrabela z podvodu s dotacemi na covid (cca 1,7 mil. Kč)', 'https://www.seznamzpravy.cz/clanek/domaci-kauzy-policie-obvinila-poradatele-demonstraci-vrabela-z-podvodu-s-dotacemi-na-covid-238163')] },
        lze: { text: 'V roce 2022 šířil ve videu pro tisíce sledujících tvrzení, že česká vláda chystá jaderný útok na Rusko, na který Rusko odpoví zásahem ČR; resort obrany toto označil za hoax (ČR takové zbraně nemá). Manipulátoři.cz dokumentují i jeho dlouhodobě nepravdivá tvrzení o situaci na Ukrajině po roce 2014. Za jaderný hoax ho Městský soud pro Prahu 1 v dubnu 2023 nepravomocně odsoudil pro šíření poplašné zprávy; Ústavní soud rozsudek v březnu 2025 zrušil a v červenci 2025 nabylo právní moci osvobození — soud výrok posoudil jako politický projev, nikoli tvrzení faktu. Trestní rovina tedy padla; samotná nepravdivost tvrzení doložená zůstává.',
          src: [S('iROZHLAS', 'OVĚŘOVNA: Český jaderný útok na Rusko? Nemáme takové zbraně, vyvrací Vrabelův hoax resort obrany', 'https://www.irozhlas.cz/zpravy-domov/overovna-ladislav-vrabel-jaderna-valka-dezinformace-hoax-policie_2212010500_pik'), S('Manipulátoři.cz', 'Ladislav Vrábel a lži o situaci na Ukrajině po roce 2014', 'https://manipulatori.cz/ladislav-vrabel-a-lzi-o-situaci-na-ukrajine-po-roce-2014/'), S('iROZHLAS', 'Soud potvrdil Vrabelovo osvobození; osvobození je pravomocné (červenec 2025)', 'https://www.irozhlas.cz/zpravy-domov/politicky-projev-ne-tvrzeni-soud-potvrdil-vrabelovo-osvobozeni-tykajici-se-slov_2507260935_vdv')] },
        konzistence: { text: 'Vrábel prošel řadou názorových a stranických poloh: v roce 2010 kandidoval jako bezpartijní za Stranu zelených, kolem roku 2015 se během migrační krize obrátil proti islámu a uprchlíkům a připojil se k dezinformační scéně (později téma COVID-19), následně založil iniciativu „Česká republika na 1. místě!“ s proruskými postoji a odporem k pomoci ukrajinským uprchlíkům. Se spoluorganizátorem Jiřím Havlem se opakovaně rozešel ve sporu o statisíce korun vybrané od demonstrantů.',
          src: [S('iROZHLAS', 'Ostrý střet organizátorů demonstrací: „Nemůžu Vrabelovi poslat peníze od lidí,“ tvrdí Havel', 'https://www.irozhlas.cz/zpravy-domov/ladislav-vrabel-jiri-havel-spor-demonstrace-penize_2210071233_ako'), S('Wikipedie', 'Ladislav Vrabel — kandidatury (Strana zelených 2010, parlamentní 2021, EU 2024) a vývoj postojů', 'https://cs.wikipedia.org/wiki/Ladislav_Vrabel')] },
      },
    }),
    person({
      id: 'sladek', name: 'Miroslav Sládek', party: 'Republikáni (SPR-RSČ)',
      role: 'expposlanec PSP a Federálního shromáždění, zakladatel a předseda SPR-RSČ / Republikánů',
      scope: 'celostátní',
      category: 'Exhibicionistický zmrd',
      categoryReason: 'Sládek nebyl populista, který hledá nepřítele kvůli hlasům — on z nenávisti vůči Romům a Němcům udělal celoživotní jeviště. Demolice lavice ve sněmovně, výtržnost na Václaváku, „protiněmecké show“: forma byla vždy důležitější než výsledek. Od populisty (Okamura) ho dělí to, že Sládek nepředstíral řešení, jen produkoval skandál. Od Systémového zmrda to, že nikdy nedosáhl na páky moci.',
      dictum: 'Udělal z rasové nenávisti celoživotní představení a pak se divil, že ho zavřeli zrovna v den, kdy chtěl být prezidentem.',
      highlight: '6. ledna 1998 ho policie zatkla přímo před budovou Poslanecké sněmovny — kladl odpor a nechtěl nasednout do vozu — kvůli trestnímu stíhání za podněcování k národnostní a rasové nenávisti (rasistické útoky na německý národ z ledna 1997, obžaloba z července 1997). Sedmnáct dní strávil ve vazbě na Pankráci, a právě v té době, 20. ledna 1998, proběhla prezidentská volba, do níž sám kandidoval. Václav Havel byl ve sněmovně zvolen 99 hlasy ze 197 přítomných; kdyby směl hlasovat i vazebně stíhaný poslanec Sládek, kvórum by se zvýšilo na 100. Jeho stížnost Ústavní soud zamítl.',
      lit: ['toxicita', 'zbabelost'],
      dfens: [
        { n: 9, why: 'Celá kariéra postavená na provokaci a hraní na nejnižší instinkty — protiromská a protiněmecká rétorika jako nástroj pozornosti.' },
        { n: 1, why: 'Slovní exhibice na parlamentní půdě i na demonstracích; obsah nahradil hlasitostí a urážkou.' },
        { n: 5, why: 'Demolice poslanecké lavice po zvolení 1996, výtržnost na Václaváku, fyzické napadení — neschopnost normální interakce.' },
        { n: 8, why: 'Roli pronásledovaného mučedníka („zavřel mě Havel“) pěstoval jako součást vlastní image dlouho po konci kariéry.' },
      ],
      overrides: {
        toxicita: { text: 'Na parlamentní půdě i veřejně opakovaně pronášel dehonestující výroky vůči Romům a Němcům. Doložený výrok: „Cikáni by měli být trestně odpovědni už od narození, protože to už je jejich největší zločin.“ V lednu 1997 pronesl rasistické slovní útoky na německý národ; v červenci 1997 byl za ně obžalován z podněcování k národnostní a rasové nenávisti (soud jej obžaloby v roce 1998 zprostil). Dříve, 15. prosince 1995, byl odsouzen za výtržnictví a útok na veřejného činitele k deseti měsícům s podmíněným odkladem na 18 měsíců (incidenty kolem oslav 28. října na Václavském náměstí).',
          src: [S('Romea.cz', 'Rasistické a populistické výroky politiků — od Sládka po Chaloupku (citovaný protiromský výrok)', 'https://romea.cz/cz/domaci/rasisticke-a-populisticke-vyroky-politiku-od-sladka-az-po-chaloupku'), S('Osmičky / ÚSD AV ČR', 'Miroslav Sládek byl zatčen (obžaloba za útoky na německý národ, leden 1998)', 'https://www.osmicky.usd.cas.cz/miroslav-sladek-byl-zatcen/?rok=1998'), S('TN.cz / Nova', 'Šéf republikánů Sládek dostal trest za výtržnictví (odsouzení 1995)', 'https://tn.nova.cz/zpravodajstvi/clanek/200108-televizni-noviny-pred-15-lety-sef-republikanu-sladek-dostal-trest-za-vytrznictvi')] },
        zbabelost: { text: 'Trestnímu stíhání za výroky o německém národě se podle dobových zdrojů dlouhodobě a opakovaně vyhýbal — pětkrát se s advokátem pokusil oddálit soudní jednání, což vedlo k jeho vzetí do vazby. Po zatčení před sněmovnou kladl aktivní odpor a odmítal nasednout do policejního vozu. Vlastní výroky vůči německému národu odmítal vysvětlit.',
          src: [S('Respekt', 'Proč zavřeli Sládka (opakované maření jednání, odmítání vysvětlení)', 'https://www.respekt.cz/tydenik/1998/4/proc-zavreli-sladka'), S('Osmičky / ÚSD AV ČR', 'Miroslav Sládek byl zatčen (aktivní odpor při zatýkání)', 'https://www.osmicky.usd.cas.cz/miroslav-sladek-byl-zatcen/?rok=1998')] },
        konzistence: { text: 'Sládek je naopak dlouhodobě konzistentní ve svých extrémních xenofobních postojích — od 90. let přes marginální Republikány až po pozdější platformy proti EU a NATO. Žádné doložené otáčení kabátu, proto osa nesvítí.' },
        penize: { text: 'K osobnímu obohacení či netransparentnímu financování strany nejsou v prověřených zdrojích doložené konkrétní kauzy. Strana byla v lednu 2026 rozpuštěna Nejvyšším správním soudem pro nepodávání výročních finančních zpráv — administrativní pochybení, nikoli doložená korupce.' },
        prace: { text: 'Mandát poslance Federálního shromáždění (1992) a Poslanecké sněmovny (1996–1998) bez doložené legislativní stopy; činnost republikánů se soustředila na obstrukce a provokace, nikoli na výsledky — to ale spadá pod exhibicionismus, ne pod samostatně doloženou osu „neudělá nic pořádně“.' },
      },
    }),
  ];
