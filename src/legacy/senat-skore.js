...
window.SENAT_SKORE = {
  ...
  'kand-3-9': {
    ...
    categoryReason: 'Přes třicet let kolem politiky — ČSSD, Zemanova SPOZ, Okamurovo SPD — a vždy neúspěšně. Křižování ideologicky neslučitelných táborů podle volitelnosti rozsvěcuje konzistenci (přeběh přes spektrum svítí i bez získaného mandátu). Profesí veden jako právník, doložený výstup za ta léta ale chybí, což rozsvěcuje i osu práce. Dvě osy bez finančního ocasu a bez toxicity — oportunista, ne plnokrevný zmrd.',
    dictum: 'Tři desetiletí v politice, tři neslučitelné stranické dresy a ani jeden doložený výsledek — jen kandidatura za tím, co zrovna táhne.',
    lit: ['konzistence', 'prace'],
    highlight: 'Kandidoval postupně za ČSSD, Zemanovu SPOZ i Okamurovo SPD (v senátních volbách 2020 v obvodu Cheb skončil na 7,31 %). Od středolevé ČSSD přes populistickou SPOZ ke krajně pravicovému SPD — tři tábory, které se navzájem programově vylučují, prošel podle toho, kde byla zrovna šance.',
    overrides: {
      ...
      prace: { text: 'Přes tři desetiletí v komunální politice Plesné a opakovaných kandidaturách za měnící se strany. Profesí veden jako právník, doložený profesní výstup (vedené případy, publikace) ani politický výsledek se za tu dobu nedohledává — dlouhá dráha kolem politiky bez prokázaného reálného výkonu.', src: [{ p: 'Hlídač státu', t: 'Josef Kvasnička — kandidatury a funkce', u: 'https://www.hlidacstatu.cz/osoba/josef-kvasnicka' }] },
      konzistence: { text: 'Doložená série kandidatur přes ideologicky neslučitelné tábory: ČSSD, poté Zemanova SPOZ a nakonec Okamurovo SPD (senátní volby 2020, 7,31 %). Křižování od středolevé ČSSD přes populismus ke krajní pravici podle volitelnosti — i pouhé neúspěšné kandidatury napříč spektrem osu rozsvěcují.', src: [{ p: 'Wikipedie', t: 'Josef Kvasnička — rozcestník (politik SPOZ, ročník 1950)', u: 'https://cs.wikipedia.org/wiki/Josef_Kvasni%C4%8Dka_(rozcestn%C3%ADk)' }, { p: 'Hlídač státu', t: 'Josef Kvasnička — kandidatury a funkce', u: 'https://www.hlidacstatu.cz/osoba/josef-kvasnicka' }] },
